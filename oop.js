...
// class person {
//   constructor(obj) {
//     (this.name = obj.name), (this.address = obj.address), (this.DOB = obj.DOB);
//   }
//   bio() {
//     console.log(
//       `Hello I am ${this.name} lives in ${this.address} and I am ${this.getAge()} years old`
//     );
//   }
//   getAge() {
...
//   }
// }
// const sahil = new person(sahilObj);
// sahil.bio();
